...
data = pd.read_csv('../data/phytobase.csv', encoding='unicode_escape')  # full DF from dataset
...
micro_df: pd.DataFrame = clean_microscopy_df(pd.read_csv('../data/micro_lter_few.csv'))  # for testing use only
